...
public class VOIE_1_to_monte_charge_rangee2{
	...
	public VOIE_1_to_monte_charge_rangee2(Parking sur un bateau R4 m) {
		this.machine = m;
	}
	...
	/*@ public normal_behavior
		requires true;
 		assignable \nothing;
		ensures \result <==> (!machine.get_Voie_arrive_1().apply(new Integer(0)).equals(machine.none) && machine.get_Borne_1().equals(true) && machine.get_Monte_charge_etage().equals(new Integer(1)) && (new Integer(machine.get_Test_full_rangee2() + machine.get_value_vehicules().apply(machine.get_Voie_arrive_1().apply(new Integer(0))))).compareTo(new Integer(3)) <= 0 && machine.get_Barriere_acces_monte_charge().equals(true) && machine.get_Barriere_monte_charge().apply(new Integer(1)).equals(true)); */
	public /*@ pure */ boolean guard_VOIE_1_to_monte_charge_rangee2() {
	...
	/*@ public normal_behavior
		requires guard_VOIE_1_to_monte_charge_rangee2();
		assignable machine.Monte_charge_rangee2, machine.Voie_arrive_1, machine.Barriere_voie1, machine.Borne_1, machine.Test_full_rangee2, machine.N_slot_full_rangee2, machine.target_etage_rangee2, machine.Virtual_etages;
		ensures guard_VOIE_1_to_monte_charge_rangee2() &&  machine.get_Monte_charge_rangee2().equals(\old((new BRelation<Integer,Integer>(new Pair<Integer,Integer>(1,machine.get_Voie_arrive_1().apply(0))).union(new BRelation<Integer,Integer>(new Pair<Integer,Integer>(2,machine.get_Monte_charge_rangee2().apply(1))).union(new BRelation<Integer,Integer>(new Pair<Integer,Integer>(3,machine.get_Monte_charge_rangee2().apply(2)))))))) &&  machine.get_Voie_arrive_1().equals(\old((machine.get_Voie_arrive_1().override(new BRelation<Integer,Integer>(new Pair<Integer,Integer>(0,machine.none)))))) &&  machine.get_Barriere_voie1() == \old(false) &&  machine.get_Borne_1() == \old(false) &&  machine.get_Test_full_rangee2() == \old(new Integer(machine.get_Test_full_rangee2() + machine.get_value_vehicules().apply(machine.get_Voie_arrive_1().apply(0)))) &&  machine.get_N_slot_full_rangee2() == \old(new Integer(machine.get_N_slot_full_rangee2() + 1)) &&  machine.get_target_etage_rangee2().equals(\old((new BRelation<Integer,Integer>(new Pair<Integer,Integer>(1,machine.get_Temporary_target_1())).union(new BRelation<Integer,Integer>(new Pair<Integer,Integer>(2,machine.get_target_etage_rangee2().apply(1))).union(new BRelation<Integer,Integer>(new Pair<Integer,Integer>(3,machine.get_target_etage_rangee2().apply(2)))))))) &&  machine.get_Virtual_etages().equals(\old((machine.get_Virtual_etages().override(new BRelation<Integer,Integer>(new Pair<Integer,Integer>(machine.get_Temporary_target_1(),new Integer(machine.get_Virtual_etages().apply(machine.get_Temporary_target_1()) + machine.get_value_vehicules().apply(machine.get_Voie_arrive_1().apply(0))))))))); 
	 also
		requires !guard_VOIE_1_to_monte_charge_rangee2();
		assignable \nothing;
		ensures true; */
