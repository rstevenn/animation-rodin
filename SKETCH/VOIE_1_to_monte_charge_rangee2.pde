// The machine VOIE_1_to_monte_charge_rangee2 that handle the push to foreight elevator event
public class VOIE_1_to_monte_charge_rangee2{
  ...
  // run and animate the event
    if (ACTION == false && SelectEvent == 27){
    ...
    else if (ACTION == true && SelectEvent == 27){
