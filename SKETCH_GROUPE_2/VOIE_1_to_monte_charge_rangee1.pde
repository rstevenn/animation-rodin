// The machine VOIE_1_to_monte_charge_rangee1 that handle the push to foreight elevator event
public class VOIE_1_to_monte_charge_rangee1{
  ...
  public void run_VOIE_1_to_monte_charge_rangee1(){
    ...
    if (ACTION == false && SelectEvent == 26){
      if(guard_VOIE_1_to_monte_charge_rangee1()){
        ...
        Monte_charge_rangee1 = new BRelation<Integer,Integer>(new Pair<Integer,Integer>(1,Voie_arrive_1_tmp.apply(0))).union(new BRelation<Integer,Integer>(new Pair<Integer,Integer>(2,Monte_charge_rangee1_tmp.apply(1))).union(new BRelation<Integer,Integer>(new Pair<Integer,Integer>(3,Monte_charge_rangee1_tmp.apply(2)))));
        ...
        Borne_1 = false;
        Test_full_rangee1 = new Integer(Test_full_rangee1_tmp + value_vehicules.apply(Voie_arrive_1_tmp.apply(0)));
        N_slot_full_rangee1 = new Integer(N_slot_full_rangee1_tmp + 1);
        target_etage_rangee1 = new BRelation<Integer,Integer>(new Pair<Integer,Integer>(1,Temporary_target_1)).union(new BRelation<Integer,Integer>(new Pair<Integer,Integer>(2,target_etage_rangee1_tmp.apply(1))).union(new BRelation<Integer,Integer>(new Pair<Integer,Integer>(3,target_etage_rangee1_tmp.apply(2)))));
    ...
    else if (ACTION == true && SelectEvent ==26){
