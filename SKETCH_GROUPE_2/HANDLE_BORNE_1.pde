  ...
  HANDLE_BORNE_1(){print("HANDLE_BORNE_1 created\n");}
	...
	boolean guard_HANDLE_BORNE_1() {
		return (Borne_1.equals(false) && (Voie_arrive_1.apply(new Integer(0)) != none) &&
            (new Integer(Etages.apply(new Integer(1)) + value_vehicules.apply(Voie_arrive_1.apply(new Integer(0))))).compareTo(new Integer(6)) <= 0 &&
            (!Voie_arrive_1.apply(new Integer(0)).equals(voiture) || 
            (new Integer(Etages.apply(new Integer(2)) + 
            value_vehicules.apply(Voie_arrive_1.apply(new Integer(0))))).compareTo(new Integer(6)) <= 0 || 
            (new Integer(Etages.apply(new Integer(3)) + value_vehicules.apply(Voie_arrive_1.apply(new Integer(0))))).compareTo(new Integer(6)) <= 0 )&&
